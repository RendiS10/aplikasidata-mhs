...
Aplikasi ini adalah sistem manajemen data mahasiswa berbasis web yang terdiri dari **backend (Express.js)** dan **frontend (Next.js)** dalam satu repository (monorepo). Semua fitur tetap sama, namun struktur sudah digabung agar lebih mudah dijalankan dan dikembangkan.
